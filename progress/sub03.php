    ...
    <div id="svis" class="svis4">
        <div class="inner">
            ...
            <ul class="snb">
                ...
                <li class="active"><a href="./sub03.php">시험 취소 신청</a></li>
                    ...
                    <table class="__tbl-list progress_table1">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>￦7,282,000</td>
                                <td><p class="progress_type cancle_type">부결</p></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td>KTS220549</td>
                                ...
                                <td>￦7,282,000</td>
                                <td><p class="progress_type cancle_type2">취소</p></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
...
<script>
    document.title = "시험 취소 신청 :: KATECH 한국자동차연구원";
</script>
</html>
